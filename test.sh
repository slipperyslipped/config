...
install_amd_drivers() {
    ...
    read -p "Please download the AMD Drivers .deb file from https://www.amd.com/en/support/linux-drivers and provide the full path to the AMD driver .deb file: " deb_file_path
...
options=("Begin Installation" "Final Steps" "Quit")
